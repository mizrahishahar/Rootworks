...
| **The intent table** | client ClayRoots base | full table standard: `relevance` formula + `manually_approved`, standing chain views, client share view + link in the table description, `Campaigns` links, `Deploy Error` |
