...
// mirror / DNC ids resolved upstream.
...
if(still.length){
  ...
  throw new Error('Could not create these Hiring signal extras on Companies ('+cfg.tableId+'): '+still.join(', ')+(why?' ('+why+')':'')+'. Nothing was spent or written.');
}
