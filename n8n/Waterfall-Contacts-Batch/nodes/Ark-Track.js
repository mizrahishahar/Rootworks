...
// governor, so this also carries what the governor did: how many answers were 429, how many
// storms it slept through (backoffs), whether it finally gave up, and how many planned companies
// were therefore never submitted (unserved). Since 2026-09-03 a storm sleeps and resumes, so
// unserved is normally zero and only a lane that stormed eight times running leaves any. Response
...
const st={ pending:[], done:[], toPoll:[], errors:[], submitted:0, planned:planned, rateLimited:0, unserved:0, stoppedEarly:stoppedEarly, backoffs:backoffs, submittedAt:Date.now(), attempts:0, callbacks:0 };
