...
- **Pull-ins land hours later, in bursts.** *16 Sep 2026.* A 150-row push at 12:12 UTC showed up as prospects at 16:58 and again in a burst at 00:30 the next night. The deploy's readback runs 90 seconds after the push, so it always reports "landed 0" and stamps nothing. Its "campaign shows no prospects at all, is it paused?" warning also fired on a campaign holding 352 prospects. Neither means the campaign is paused or broken. Judge landing with `list_prospects(campaignId)` and `createdAt`, hours after the push, and never rerun a feed on "landed 0" alone.
