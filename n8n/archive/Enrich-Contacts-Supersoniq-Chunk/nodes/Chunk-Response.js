// Chunk Response: the last node of the Supersoniq chunk worker, what the lane receives: the vendor
...
return [{ json:{ provider:'Supersoniq', parse:{ status:p.status||'error', reason:p.reason||'', stats:p.stats||{} }, writer } }];
