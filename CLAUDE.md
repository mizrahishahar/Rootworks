...
- **The skills** are your expertise: one per domain, pure craft, nothing about our infrastructure. They are yours to write and keep; the Operator never reads them. He gives context in schemas and standards and says what he needs; he judges what comes out; when an output is wrong he says so in the terms of the output, and you fix the skill and log the lesson. Load the domain's skill before working in it, and this file tells it which schema and which standard it works under:
