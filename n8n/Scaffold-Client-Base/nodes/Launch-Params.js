...
// Signals" / "<Client> Campaigns"). Nothing else on the row is read. A missing piece stops the
// run here, before a single meta-API call. Resets the scaffold state at the trigger.
