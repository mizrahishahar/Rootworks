...
// an empty column takes the caller's own value (Normalize), else what the client's People table held
// (base_person from Enrich and Qualify Lead), else stays empty. Create CRM Contact reads this item.
...
const position = pick('position', n.job_title, bp.title);
