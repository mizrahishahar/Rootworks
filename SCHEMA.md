...
<!-- @@register-section: everything below is compiled by scripts/register.js -->
...
| Contact Source | multipleSelects |  | plain |
...
| Signals | relevance = 1 and Signals is not empty. Needs the synced Signals mirror: the filter reads a lookup of Companies.Signals, a mirrorLink, so a base without the mirror cannot carry this view | `AND({relevance} = 1, {Signals} != BLANK())` | Name, Title, Seniority, Department, Company, Description, Employees, Email, LinkedIn URL, Contact Source, Tag, Signals, Signal At, Build Date | Signal At desc |
...
- **source**: Blitz cyanLight2; GetLeads greenLight2; QuickEnrich yellowLight2; Supersoniq purpleLight2; ContaGen blueLight2; AI-Ark tealLight2
