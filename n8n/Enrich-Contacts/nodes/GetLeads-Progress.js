// GetLeads Progress (one file per node, the pull keeps them apart; same code for the four): after each provider lane closes, the launch row is updated in place (ruled
