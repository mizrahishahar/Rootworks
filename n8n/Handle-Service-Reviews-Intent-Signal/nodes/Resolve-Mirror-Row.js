...
// relation: refuse here, nothing spent, nothing written. Emits the write contract (Verify
// Extras) plus the mirror row id Build Companies links to. Reused verbatim from the hiring handler.
const cfg=$('Parse Play').first().json;
const t=$('Verify Extras').first().json;
let mirrorId='';
