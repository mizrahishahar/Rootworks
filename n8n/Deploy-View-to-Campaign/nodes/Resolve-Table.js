...
// comes from the base schema just read, never from the Hub (ClayRoots Standard, law 3). Runs on
// the schema phase of the meta loop only; the view phase passes straight through to Meta Router,
