...
// View, Sources, Departments, Max companies). This is how an insert door calls this machine after
// landing: Table "Companies", View "Not Sourced". Shape it like Fetch Launch Record's output so
// Resolve Base and Launch Params read one shape on both entries; the camelCase spellings a door
// might send are folded into the row keys here.
...
alias('Table',['table']); alias('View',['view']); alias('Sources',['sources']); alias('Departments',['departments']); alias('Max companies',['maxCompanies','max_companies']);
