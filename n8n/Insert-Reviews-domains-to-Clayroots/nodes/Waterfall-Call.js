...
// formula and the views on People do all the cutting. The Signals row's Roles field is the
// signal's own intent, not a contact filter, and is deliberately not read here.
//
