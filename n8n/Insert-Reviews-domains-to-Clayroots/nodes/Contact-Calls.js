...
//   AI-Ark people search: a fixed wide title vocabulary (decision makers AND practitioners),
//   WORD mode, size 12; 0.5 credits per returned profile (max 6 cr/company).
//
