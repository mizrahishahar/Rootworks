...
- **`warmup_reply_rate` on the bulk update is a fraction, 0 to 1.** Send 0.35; the account reads back `reply_rate: 35`. Sending 35 is rejected with "must be less than or equal to 1". Proven on the dave-4 batch, 2026-09-08.
