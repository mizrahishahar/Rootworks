...
return [{ json: {
  ...
  native_phone:d.phone_number||'', existing_brief:d.custom_qualification_brief||'',
  event_type:event_type, booked_time:booked_time,
