...
return [{ json:{ qualificationStatus, verdict:status, verdictReason:vreason, briefMd:q.brief_md||'', brief:q.brief||'', situation:q.situation_summary||'', recommended:q.recommended_action||'', timezone:String(q.timezone||''), companyName:String(q.company_name||''), contextNotes, attributionLine:line, kbFound:q.kb_found!==false } }];
