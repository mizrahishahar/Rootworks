...
// same lane). MV P1..P3 are not required: Verdict writes the tier column only when the table
// carries it and falls back to MV P0. Diffs by exact name against the schema Resolve Table
// already read and refuses before the first paid call when anything is missing.
// @@register
const LANE=['MV P0','BB','Final Email','Email Source','Status'];
