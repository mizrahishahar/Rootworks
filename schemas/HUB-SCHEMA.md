...
| Left in View | `fld7rapMCXQw9l3PR` | number | Deploy doors. After the run: rows the view could still give (after DNC, the Campaigns stamp and the variable check) minus what this run sent. Zero means the view is dry. The Campaigns Manager reads the newest deploy row per campaign. |
