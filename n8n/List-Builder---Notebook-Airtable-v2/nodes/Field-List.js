...
const defs=[ sel('MV P0',MV), sel('BB P0',BB), txt('P1 (Trykitt)'), sel('MV P1',MV), sel('BB P1',BB), txt('P2 (LeadMagic)'), sel('MV P2',MV), sel('BB P2',BB), txt('Final Email'), sel('Source',[{name:'P0',color:'blueBright'},{name:'P1',color:'cyanBright'},{name:'P2',color:'tealBright'},{name:'none',color:'grayBright'}]), sel('Status',[{name:'done',color:'greenBright'},{name:'no_email_found',color:'redBright'},{name:'error',color:'orangeBright'}]) ];
